 ...
 *      Button2: Increase PWM Duty Cycle (+%5)
 *      Button3: Increase PWM Duty Cycle (-%5)
 *
 *      # Connections
 *      ---------------------------------------------------------------
 *      * Button1    -> P09
 ...
 *      ---------------------------------------------------------------
 *      * Initial PWM duty cycle of each led is %15.
 *      * PWM duty cycle interval range from %5 to %60.
 *
 *      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
...
int32_t redDutyCyclePercent = 15;
int32_t  greenDutyCyclePercent = 15;
int32_t  yellowDutyCyclePercent = 15;
        ...
        else if ((GPIO_PinRead(GPIO, GPIO_PORT, BUTTON_2) == 1) && !button1Pressed && !button3Pressed)
        {
            if (!button2Pressed)
            {
                ...
                if (GPIO_PinRead(GPIO, GPIO_PORT, BUTTON_2) == 1)
                {
                    ...
                    {
                        case 0:
                            redDutyCyclePercent += 5;
                            if (redDutyCyclePercent >= 60)
                            {
                                redDutyCyclePercent = 60;
                                break;
                            }
                            break;
                        case 1:
                            greenDutyCyclePercent += 5;
                            if (greenDutyCyclePercent >= 60)
                            {
                                greenDutyCyclePercent = 60;
                                break;
                            }
                            break;
                        case 2:
                            yellowDutyCyclePercent += 5;
                            if (yellowDutyCyclePercent >= 60)
                            {
                                yellowDutyCyclePercent = 60;
                                break;
                            }
                            break;
                    }
