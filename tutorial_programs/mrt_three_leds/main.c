// Developed based on Ahmet Onat's MRT Timer Example.

// This program is an example program for using the MRT peripheral.
// * Generates a timer interrupt every 10 milliseconds.
// * It determines the output status by increasing the state every 500 milliseconds.
